      ...
      <div className="about-us-container">
        <div className="text-container">
          ...
          <p>
            ...
            and the Terms goes : 1. Eathub is responsible for the availability
            ...
            support services. 2. Eathub is to provide technological tools such
            as website, mobile application and other technological interface. 3.
            The Proposed Client is to have the option to access different
            ...
            Food logistics (Food delivery), and customer service. 4. The
            Proposed Client is to make available location operated and owned by
            the client service to Eathub. 5. The Proposed Client is to make
            available it's information to be verified at intervals to Eathub. 6.
            Also, Eathub is here to provide a technology that connects customers
            to the Proposed client's business. 7. The Proposed Client however,
            ...
            purposes which is the responsibility of Eathub. 8. Clients however
